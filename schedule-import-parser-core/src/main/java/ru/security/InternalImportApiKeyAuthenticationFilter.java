...
public class InternalImportApiKeyAuthenticationFilter extends OncePerRequestFilter {

    private static final String INTERNAL_API_KEY_HEADER = "X-Internal-Api-Key";

    private final String internalApiKey;

    public InternalImportApiKeyAuthenticationFilter(String internalApiKey) {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return requestUri == null || !requestUri.startsWith("/internal/import/");
    }
